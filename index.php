...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=346041422164974";
...
echo "Your Proxy IP address is : ".$pipaddress. "(via $ipaddress)" ;
		...
		$uid = $_SESSION['views'];
		echo "<font size='6' color='pink'>$uid Your IP: $ipaddress </font>";
...
<form style="display: inline" method="get" action="index.php">
    <table class="auto-style1">
        <tr>
            <td class="auto-style2" rowspan="3" style="vertical-align: middle">
    <button style="height: 50px; width: 200px ; background: url(hk.jpeg)no-repeat" type="submit"><strong>Create QR</strong></button></form>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <form style="display: inline" method="get" action="decrypt.php"><button style="height: 50px; width: 200px ; background: url(hk.jpeg)no-repeat"type="submit"><strong>Encrypt/Decrypt</strong></button></form>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </td>
            <td>
<div class="fb-login-button" autologoutlink="true" data-show-faces="true" data-width="260" data-max-rows="2"></div>
            </td>
        </tr>
        <tr>
            <td>
<div class="fb-send" data-href="http://skyynet.cloudapp.net/QR" data-colorscheme="dark" data-font="verdana" id="v"></div>
            </td>
        </tr>
        <div>
		</div>
...
echo '<font size="6" color="pink">Skyynet Secret QR Maker</font></br></br>';
...
try{
mysql_query("Insert INTO logs (ip, message, key1, username) VALUES ('$ipaddress', '$string1' , '$key','$dbid' )");
}
catch (Exception $e)
{
